...
<div class="container" id="login-block">
    <div class="row align-items-center my-sm-0 my-5" style="min-height: 100vh;">
        <div class="col-sm-6 col-md-5">
            <div class="account-wall card card-light" style="background-color: #183f4e;">
                <div class="text-center" style="margin-bottom: 20px;">
                    <img src="{{url('/images/delivery-logo.png')}}" style="height: 300px; width:300px;">
                   <!--  <h3 style="text-align: center; font-weight: bold;">Delivery System Connecting Local shops and customers</h3> -->
                    <hr>
                </div>
    ...
    <p class="account-copyright" style=" position:fixed;bottom:0;">
        <span>Delivery System &copy; 2021 </span>
    </p>
